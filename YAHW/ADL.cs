...
namespace ATI.ADL
{
    ...
    internal delegate int ADL_Adapter_MemoryInfo_Get(int size);
    ...
    internal static class ADL
    {
        ...
        private static class ADLImport
        {
            ...
            [DllImport(Atiadlxx_FileName)]
            internal static extern int ADL_Adapter_MemoryInfo_Get(int adapterIndex);
        ...
        internal static ADL_Adapter_MemoryInfo_Get ADL_Adapter_MemoryInfo_Get
        {
            get
            {
                if (!ADL_Adapter_MemoryInfo_Get_Check && null == ADL_Adapter_MemoryInfo_Get_)
                {
                    ADL_Adapter_MemoryInfo_Get_Check = true;
                    if (ADLCheckLibrary.IsFunctionValid("ADL_Adapter_MemoryInfo_Get"))
                    {
                        ADL_Adapter_MemoryInfo_Get_ = ADLImport.ADL_Adapter_MemoryInfo_Get;
                    }
                }
                return ADL_Adapter_MemoryInfo_Get_;
            }
        }
        /// <summary> Private Delegate</summary>
        private static ADL_Adapter_MemoryInfo_Get ADL_Adapter_MemoryInfo_Get_ = null;
        /// <summary> check flag to indicate the delegate has been checked</summary>
        private static bool ADL_Adapter_MemoryInfo_Get_Check = false;
